...
class Caribe extends React.Component {
  ...
  constructor(props) 
    ...
    componentDidMount() 
    {
      fetch('http://localhost:2999/paises/Caribe')
        .then((response) => {
...
<div class="row">
    ...
    <div class="col-md-1" > <img src={ca} className="banderita" />   </div>
...

{
    props => (
      <div >
        <h3 className="espacio">Catalogo de Servicio - Caribe</h3>
